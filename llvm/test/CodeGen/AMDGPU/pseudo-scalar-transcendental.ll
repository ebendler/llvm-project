...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck -check-prefixes=GFX12,GFX12-GISEL %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=fiji < %s | FileCheck -check-prefixes=GCN-GISEL %s
...
; GCN-GISEL-NEXT:    v_cmp_lt_f32_e32 vcc, s0, v0
; GCN-GISEL-NEXT:    s_and_b64 s[2:3], vcc, exec
; GCN-GISEL-NEXT:    v_mov_b32_e32 v1, 0x42000000
; GCN-GISEL-NEXT:    s_cselect_b32 s1, 32, 0
; GCN-GISEL-NEXT:    v_cndmask_b32_e32 v0, 0, v1, vcc
; GCN-GISEL-NEXT:    v_mov_b32_e32 v1, s1
; GCN-GISEL-NEXT:    v_ldexp_f32 v1, s0, v1
; GCN-GISEL-NEXT:    v_log_f32_e32 v1, v1
...
; GCN-GISEL:       ; %bb.0:
; GCN-GISEL-NEXT:    v_mov_b32_e32 v0, 0x800000
; GCN-GISEL-NEXT:    v_cmp_lt_f32_e64 vcc, |s0|, v0
; GCN-GISEL-NEXT:    s_and_b64 s[2:3], vcc, exec
; GCN-GISEL-NEXT:    v_mov_b32_e32 v1, 0x42000000
; GCN-GISEL-NEXT:    s_cselect_b32 s1, 32, 0
; GCN-GISEL-NEXT:    v_cndmask_b32_e32 v0, 0, v1, vcc
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_xor_b32 s1, s0, 0x80000000
; GFX12-NEXT:    s_cmp_gt_f32 s0, 0x80800000
; GFX12-NEXT:    s_cselect_b32 s0, 0x4f800000, 1.0
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_2)
; GFX12-NEXT:    s_mul_f32 s0, s1, s0
; GFX12-NEXT:    s_cselect_b32 s1, 0x42000000, 0
; GFX12-NEXT:    v_s_log_f32 s0, s0
; GFX12-NEXT:    s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_2)
; GFX12-NEXT:    s_sub_f32 s0, s0, s1
...
; GCN-GISEL:       ; %bb.0:
; GCN-GISEL-NEXT:    v_mov_b32_e32 v0, 0x80800000
; GCN-GISEL-NEXT:    v_cmp_gt_f32_e32 vcc, s0, v0
; GCN-GISEL-NEXT:    s_and_b64 s[2:3], vcc, exec
; GCN-GISEL-NEXT:    v_mov_b32_e32 v1, 0x42000000
; GCN-GISEL-NEXT:    s_cselect_b32 s1, 32, 0
; GCN-GISEL-NEXT:    v_cndmask_b32_e32 v0, 0, v1, vcc
